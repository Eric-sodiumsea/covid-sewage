...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        // ⼀、修改数据源
        dsc.setUrl("jdbc:mysql://localhost:3306/covid19-temp?useUnicode=true&characterEncoding=UTF8&useSSL=false&serverTimezone=GMT%2B8");
